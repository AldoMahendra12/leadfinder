...
export async function initiateWarmupSend(force = false) {
  ...
  // Always send FROM the verified Brevo sender identity.
  // Virtual contacts are used as the recipient — Brevo does not need to verify recipients.
  // (The old approach of overriding SENDER_EMAIL caused Brevo 400 rejections.)
  try {
